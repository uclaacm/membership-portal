module.exports = (Sequelize, db) => {
  ...
  Activity.accountCreated = function(user) {
    return this.create({ 
      user,
      type: 'ACCOUNT_CREATE',
      public: true,
  ...
  Activity.accountActivated = function(user) {
    return this.create({ 
      user,
  ...
  Activity.accountResetPassword = function(user) {
    return this.create({ 
      user,
  ...
  Activity.accountRequestedResetPassword = function(user) {
    return this.create({ 
      user,
  ...
  Activity.accountLoggedIn = function(user) {
    return this.create({ 
      user,
      type: 'ACCOUNT_LOGIN',
    });
